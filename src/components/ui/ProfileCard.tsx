        ...
        <div className="fixed inset-0 bg-black bg-opacity-30 flex justify-center items-center">
            <div className="bg-white shadow-md rounded-lg w-96 p-6 relative">
                ...
                <div className="flex items-center space-x-4 mb-6">
                    <img
                        src="https://example.com/avatar.png" // 替换为真实头像图片
                        alt="avatar"
                        className="w-12 h-12 rounded-full"
                    />
                    <div>
                        <p className="text-lg font-semibold">Yuki</p>
                    </div>
                </div>

                {/* Email Section */}
                <div className="mb-6">
                    <h3 className="text-sm font-semibold text-gray-500">电子邮件地址</h3>
                    <p className="text-sm text-gray-800">903728862@qq.com</p>
                    <button className="text-sm text-blue-500 mt-2">添加电子邮件地址</button>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center space-x-2">
                        ...
                        <p className="text-sm text-gray-800">GitHub - binaryyuki</p>
                    </div>
